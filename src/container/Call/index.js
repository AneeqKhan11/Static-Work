...
const Call = () => {
  return (
    <View style={{ flex: 1, paddingTop: 10 }}>
                    ...
                    <TouchableOpacity style={styles.MyStatusBox}>
                        <View style={styles.Status_Profile}>
                            <View style={styles.ChatProfile1}>
                              <Icon name='link' type='fontisto' color='white' size={25}/>
                            </View>
                        </View>
                        <View style={styles.Status_MyStatus}>
                            <Text style={styles.Status_Text}>Create call link</Text>
                            <Text style={styles.Status_Text_1}>Share a link for your WhatsApp call</Text>
                        </View>
                    </TouchableOpacity>
            ...
            <Button Button={styles.uplode_PicButton} name='add-ic-call' color='white' type='material' size={30} />
        </View>
  )
}
